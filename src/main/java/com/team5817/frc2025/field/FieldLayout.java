...
public class FieldLayout {
	...
	static {
        ...
        private static final AlignmentPoint kReefToRightAlign = new AlignmentPoint(new Translation2d(-(RobotConstants.kBumberSideLength+0.3158)/2, -0.1643),AlignmentType.CORAL_SCORE,AlignmentType.CORAL_SCORE_RIGHT);
        private static final AlignmentPoint kReefToLeftAlign = new AlignmentPoint(new Translation2d(-(RobotConstants.kBumberSideLength+0.3158)/2, 0.1643),AlignmentType.CORAL_SCORE,AlignmentType.CORAL_SCORE_LEFT);
