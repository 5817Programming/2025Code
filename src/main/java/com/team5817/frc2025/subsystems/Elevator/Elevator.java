...
public class Elevator extends ServoMotorSubsystem {
	...
	public enum State {
		...
		L3O(1.211806509200769-.06, kStrictError, ElevatorConstants.kMidOffsetMap),
		L3(1.211806509200769-.045, kStrictError, ElevatorConstants.kMidOffsetMap),
		L2O(.754804-.02, kStrictError, ElevatorConstants.kMidOffsetMap),
		L2(.754804-.01, kStrictError, ElevatorConstants.kMidOffsetMap),
